...
import io.samos.wallet.utils.NetUtil;
...
public class RetrofitService {
    ...
    private static final Interceptor sRewriteCacheControlInterceptor = new Interceptor() {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (!NetUtil.isNetworkAvailable(SamosAppliacation.mInstance.getApplicationContext())) {
    ...
    private static final Interceptor sLoggingInterceptor = new Interceptor() {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (request.body() != null) {
                ...
                LogUtils.d("HEAD request.body() == null:"
                );
            }
    ...
    public static RetrofitService getInstance(){
        return RetrofitServiceHolder.mInstance;
    }
    ...
    public void init() {
        // 指定缓存路径,缓存大小100Mb
        Cache cache = new Cache(new File(SamosAppliacation.mInstance.getApplicationContext().getCacheDir(), "HttpCache"),
                1024 * 1024 * 100);
    ...
    private static class RetrofitServiceHolder{
        public static final RetrofitService mInstance = new RetrofitService();
    }
